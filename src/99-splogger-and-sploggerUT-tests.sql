...
SELECT TOP(1) * 
FROM sploggerUT.UnitTestHistory
ORDER BY Id DESC
...
BEGIN 
	...
	BEGIN TRY
		...
		-- Executing the SP in UT mode
		EXEC @retVal = [splogger].[SPTest_SQLException] @UTester OUT, 55, 0
