...
CREATE ROLE [splogger_user] AUTHORIZATION [<USER_SCHEMA_OWNER, NVARCHAR, dbo>]
GO
...
GRANT EXECUTE ON SCHEMA::[<USER_SCHEMA, NVARCHAR, splogger>] TO [splogger_user]
GO

--
-- Create synonyms
--
CREATE SYNONYM [<USER_SCHEMA, NVARCHAR, splogger>].[LogHistory] FOR [<SPLOGGER_DB, NVARCHAR, SPLogger>].[splogger].[LogHistory]
GO
